...
# autopilot-server の /var/lib/nuage-autopilot/kubeconfig に配置する。
...
SA_NAME=autopilot
REMOTE_PATH=/var/lib/nuage-autopilot/kubeconfig
...
ssh -F .ssh/ssh_config autopilot-server "install -m 600 /dev/null ${REMOTE_PATH}"
